...
def execute_script(scriptName):
    ...
    for line in lines:
        ...
        eval(commands[com][0])(args)  # https://qiita.com/Chanmoro/items/9b0105e4c18bb76ed4e9
...
def move_robot(args):
    ...
    #
    # for i in args.size:
    #     m = keiganGUI.Ui.params[motorSet[i]]['cont']
    #     scale = keiganGUI.Ui.params[motorSet[i]]['scale']
    #     motorPos = args[i]
    #     m.speed(keiganGUI.Ui.ui.sliderSpeedSpin.value())
