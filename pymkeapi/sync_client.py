...
class SyncClient:
    ...
    def terminate(self, method):
        ...
        return self._send_and_check(api.Request(cmd=api.CMD_TERMINATE,
                                                params=params),
                                    [api.STATUS_OK])
    ...
    def get_device_xml(self):
        """Returns description of the sensor"""
        reply = self._send_and_check(api.Request(api.CMD_GET_DEVICE_XML),
                                     [api.STATUS_OK])
    ...
    def upload_package(self, payload=bytearray(0)):
        ...
        reply = self._send_and_check(api.Request(api.CMD_UPLOAD_PACKAGE,
                                                 params=params,
                                                 payload=payload),
                                     [api.STATUS_OK])
    ...
    def __print_connected(self):
        ...
        self.__bus.verbose_print(DefaultBus.VERBOSE_INFO,
